...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/Users/anzepeharc/.buildozer/android/platform/android-ndk-r19c/sysroot/usr/include/arm-linux-androideabi -I/Users/anzepeharc/PycharmProjects/numpy_matrix_test/.buildozer/android/platform/build-armeabi-v7a/build/python-installs/testapp/include/python3.8" ],
  CPPINCLUDES => [  ],
  ...
  LDFLAGS => [ "  -L/Users/anzepeharc/PycharmProjects/numpy_matrix_test/.buildozer/android/platform/build-armeabi-v7a/build/libs_collections/testapp/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
